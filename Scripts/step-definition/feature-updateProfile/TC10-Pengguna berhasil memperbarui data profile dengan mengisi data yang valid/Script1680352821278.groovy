...
WebUI.callTestCase(findTestCase('Test Cases/pages/updateProfile-page/Update all data'), null, FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Test Cases/pages/updateProfile-page/Verify success update profile using fill all data'), null, FailureHandling.STOP_ON_FAILURE)
