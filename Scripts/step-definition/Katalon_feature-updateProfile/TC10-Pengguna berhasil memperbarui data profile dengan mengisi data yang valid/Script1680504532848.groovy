...
'Update all data'
WebUI.callTestCase(findTestCase('Test Cases/pageObject/updateProfile-page/Update all data'), [:], FailureHandling.STOP_ON_FAILURE)
...
'Verify success update profile using fill all data'
WebUI.callTestCase(findTestCase('Test Cases/pageObject/updateProfile-page/Verify success update profile using fill all data'), 
